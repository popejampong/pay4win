...
Sub ShowRecords()
    ...
    OpenQueryDNS "select * from PAH4870", objdbRs, False
    GetFields Me, objdbRs
    
    cSqlStmt = "SELECT range1, range2, AMOUNT, format(PERCENT,0) as PERCENT FROM PAH4870 order by range1 "
    ...
    Select Case MsgBox(IIf(nAdd = 1, "Save", "Update") & " TOI Table Entry?", vbYesNoCancel, App.Title)
        ...
        Case vbYes
            If nAdd = 1 Then
                With MSHFlexGrid1
                    ...
                    For nCtr = 1 To .Rows - 1
                        ...
                        If Not ((Trim(.TextMatrix(nCtr, 1)) = "") And (Trim(.TextMatrix(nCtr, 2)) = "")) Then
                            ...
                            cSqlStmt = "INSERT INTO PAH4870(RANGE1,RANGE2,AMOUNT,PERCENT,S_AMT,H_AMT,M_AMT,EX_AMT,CMPID)VALUES(" & _
                ...
                End With
            Else
                OpenQueryDNS "DELETE FROM PAH4870", objdbRs, True
                Script2File "DELETE FROM PAH4870 "
                With MSHFlexGrid1
...
'                MsgBox cSqlStmt
        ...
        ShowProgress 3
        GenerateReport "Tax On Individual Table Preview", "PRVPAH4870.RPT", , True
...
Private Sub Form_Load()
    ...
    OpenQueryDNS "SELECT * FROM PAH4870 ORDER BY RANGE1", oTempADO, False
